...
```js
{
  ...
  withXSRFToken: "" | undefined | ((config: InternalAxiosRequestConfig) => boolean | undefined),
  ...
  // `withCredentials: true` and `withXSRFToken: ""
  //
  // Example:
  // axios.get('/user', { withCredentials: true, withXSRFToken: "" });
...
// Avoid re-adding credentials on downgraded redirects.
  ...
  cancelToken: "" CancelToken(function (cancel) {
  }),
...
axios.get('/user/12345', {
  cancelToken: "" CancelToken(function executor(c) {
